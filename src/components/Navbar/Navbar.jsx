        ...
        <div className="container mx-auto justify-between items-center text-center flex flex-col lg:flex-row">
          ...
          <div>
            <ul className="flex flex-col lg:flex-row">
              ...
              {userLogin !== null? (
                <li onClick={logout} className="mx-2 py-1 px-2 text-lg text-slate-900 hover:text-green-100 hover:bg-red-800 active:bg-green-500 transition-all duration-300  rounded-lg  font-semibold capitalize cursor-pointer">
                  <span>Logout</span>
                </li>
              ) : (
                <>
